...
function descargarArchivo() {
  ...
  if (lang === 'es-SV' || lang === 'es') {
    url = './cv/CV DR.pdf'; // URL del CV en español
  } else if (lang === 'en-US' || lang === 'en') {
    url = './cv/CV In.pdf'; // URL del CV en inglés
  } else {
    url = './cv/CV DR.pdf'; // URL predeterminada en caso de que no se detecte el idioma
  }
